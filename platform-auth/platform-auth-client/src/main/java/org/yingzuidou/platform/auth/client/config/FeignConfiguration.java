...
public class FeignConfiguration implements RequestInterceptor{
    ...
    /**
     * 为feign请求添加请求头，需要注意不能使用feign的默认熔断配置，默认熔断策略是THREAD，它拿不到存放到ThreadLocal中的
     * {@link ServletRequestAttributes}属性值的
     *
     * 参考：https://blog.csdn.net/crystalqy/article/details/79083857
     *
     * @param requestTemplate 请求存放独享
     */
    @Override
