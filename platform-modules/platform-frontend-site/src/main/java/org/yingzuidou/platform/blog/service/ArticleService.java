...
public interface ArticleService {
     ...
     * @return 文章目录列表
     */
    List<ArticleDTO> retrieveKnowledgeCatalogue(Integer knowledgeId, PageInfo pageInfo);
     ...
     * @return 最近发布文章列表
     */
    List<ArticleDTO> retrieveRecentPostArticleList(Integer knowledgeId, PageInfo pageInfo);
     ...
     * @return 最近编辑的文章
     */
    List<ArticleDTO> retrieveRecentEditArticleList(Integer knowledgeId, PageInfo pageInfo);
     ...
     * @return 文章列表
     */
    List<ArticleDTO> retrieveConciseArticleList(Integer knowledgeId, PageInfo pageInfo);
     ...
     * @return 文章信息
     */
    ArticleDTO retrieveArticle(Integer articleId);
