 ...
 */
@Entity
@Table(name = "resource", schema = "platform-blog", catalog = "")
public class ResourceEntity {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id &&
                ...
                Objects.equals(defaultPage, that.defaultPage);
    }

    @Override
    public int hashCode() {

        return Objects.hash(id, resourceName, parentId, resourceType, inUse, resourcePath, resourceIcon, resourceSort, creator, createTime, updator, updateTime, isDelete, alias, defaultPage);
    }
}
